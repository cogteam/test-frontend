...
export default function Careersmodal({ show, handleClose  }) {
    ...
    <Modal show={show} onHide={handleClose} centered className="custommodal apply-wrapper casestidumodal">
      ...
      <Modal.Body className="p-0">
            <div className="query-form">
             <p className="text-center">Please fill out the form below and<br /> we will get back to you as soon as possible.</p>          
