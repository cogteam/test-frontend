...
export const TEAM_DATA = [
  ...
  },
  {
    ...
    bio: [
      "Kalpesh Vohra is a seasoned Human Resources leader with over two decades of experience across human capital consulting and enterprise HR leadership. He partners with organisations to solve complex people challenges across organization design and effectiveness, talent management, performance, total rewards, HR operating models, shared services, and HR digitization.",
      "He operates at the intersection of business strategy and human capital, ensuring people agendas are closely aligned with enterprise priorities and deliver measurable impact.",
      "Prior to Arcolab, Kalpesh worked with leading consulting firms, including a decade at Mercer, where he led practices and industry clusters across sectors, building expertise in delivering large-scale, high-impact solutions.",
