   ...
   {/* <Header/> */}
     ...
     <div className='inner-head inner-head-products product-wrapper mobile-clinical-banner'>
            <div className="banner-inner">
                ...
                <div>
                <h1 className='h4 ' data-aos="fade-up">Mobile Clinical <br />   <span>Services
</span></h1>
                    <p data-aos="fade-up" className=" col-md-7">With a nationwide presence across more than 20 sites in India and a team of over 80 specially trained study nurses, we provide comprehensive mobile clinical services designed to enhance patient convenience, ensure protocol adherence, and maintain the highest standards of quality and compliance.</p>
                </div>
            </Container>
            </div>
        </div>
