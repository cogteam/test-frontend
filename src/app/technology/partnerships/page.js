    ...
    <div className='inner-head grey career-wrapper partnerships-banner'>
        <Container className='d-flex align-items-center h-100 '>
            <div>
                ...
                <p data-aos="fade-up" className="text-white">Building strong alliances that drive meaningful growth.<br/>
Collaborating with the right partners to unlock innovation<br/> and impact. </p>
            </div>
        </Container>
    </div> 
            ...
            <Container>
                            ...
                            <Row>
                                ...
                                <div className='solution-box'>
                                    <h3 className='h5'>Powering End-to-End Serialization & Supply Chain Automation</h3>
                                        <p>Modern supply chains are becoming more connected, intelligent, and resilient — driven by real-time visibility and seamless partner collaboration. Together with <b>TraceLink</b>, we help organizations leverage the Healthcare and Life Sciences industry’s largest digital network of 291,000+ members, enabling unmatched connectivity across the supply ecosystem.</p>
                ...
                <div className='solutions-row' onClick={() => setShow(true)}>
                        ...
                        <div className='solution-box'>
                            ...
                            <p>As industries evolve, workforce readiness is becoming a key driver of operational excellence — powered by immersive, scalable, and intelligent training solutions. Together with <b>8chili</b> and its platform <b>HintVR</b>, we are transforming how organizations train, validate, and certify operators through cutting-edge AR/VR experiences.</p>
                ...
                <div className='solutions-row' onClick={() => setShow(true)}>
                            ...
                            <p>Human Capital Management is evolving into a powerful driver of growth — defined by seamless experiences, intelligent insights, and organizational agility. Together with <b>Darwinbox</b>, we are transforming how organizations attract, engage, develop, and retain talent through an AI-powered HCM platform built for the modern workforce.</p>
