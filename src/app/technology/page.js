...
export default function ProductsClient() {
        ...
        >
          <div>
            ...
            <p
              ...
              data-aos-delay="100"
            >
             Powering progress through intelligent technology.

              <br className="d-none d-md-block" />
              Driving speed, efficiency, and scalable growth.
            </p>
          </div>
        </Container>
      </div>
 ...
 <main className="pad80 product-page">
        <Container>
            <h2 className="h4 text-center mb-5">solutions</h2>
            <Solutions/>
        </Container>
</main>

      {/* Product Grid */}
      <main className="pad80 product-page grey">
        <Container>
            <h2 className="h4 text-center mb-4">Platforms</h2>
       ...
       <main className="pad80 product-page">
        <Container>
            <h2 className="h4 text-center mb-4">Partnerships</h2>
            <Partnerships />
        </Container>
</main>
